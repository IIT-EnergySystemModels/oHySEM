...
def create_variables(model, optmodel):
    ...
    setattr(optmodel, 'vHydrogenBuy',                       Var(model.psnnd,  within=NonNegativeReals, bounds=lambda model,p,sc,n,nd:(                                                        0.0, model.Par[f'pHydrogenDemand'      ][nd][p,sc,n]),                                                  doc='hydrogen buy        in node                      [tH2]'))
    setattr(optmodel, 'vHydrogenSell',                      Var(model.psnnd,  within=NonNegativeReals, bounds=lambda model,p,sc,n,nd:(                                                        0.0, model.Par[f'pHydrogenDemand'      ][nd][p,sc,n]),                                                  doc='hydrogen sell       in node                      [tH2]'))
